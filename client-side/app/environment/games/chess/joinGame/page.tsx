    ...
    <div className="bg-[url('/chess-mb.png')] md:bg-[url('/chess-lg.png')] bg-cover bg-center">
      ...
      <div className="min-h-[calc(100dvh-112px)] flex flex-col justify-center mt-2">
        <div className="w-[90%] md:w-[95%] mx-auto lg:w-[70%] xl:w-[60%] bg-violet-800 my-5 rounded-lg p-5">
          ...
          {/* code */}
          <div>
            <input className="w-[95%] rounded-lg bg-violet-900 mx-auto mt-3 h-20 flex justify-center text-center
          ...
          <div className="flex flex-col gap-3 my-5">
            <div className="flex justify-center items-center">
              <button className="bg-violet-600 flex justify-center items-center rounded
            ...
            <div className="flex gap-4 mt-5 justify-center">
              <div className="bg-violet-900 h-15 w-15 rounded-lg flex justify-center items-center">user1</div>
