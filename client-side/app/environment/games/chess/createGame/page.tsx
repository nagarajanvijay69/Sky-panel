...
const InitGame = () => {
  ...
  return <>
    <div className="bg-purple-900">
      <Header />
      <div className="text-2xl text-center mt-7">Gam<span className="border-b-2">e L</span>obby</div>
      <div className="w-[90%] md:w-[95%] mx-auto lg:w-[70%] xl:w-[60%] bg-purple-800 mt-5 rounded-lg p-5">
        <div className="text-center">Your invitation code</div>
        {/* code */}
        <div>
          <input className="w-[95%] rounded-lg bg-purple-900 mx-auto mt-5 h-20 flex justify-center text-center items-center text-3xl 
          outline-none"
        ...
        <div className="flex flex-col gap-3 mt-10 mb-5">
          <div className="flex justify-center items-center">
            <button className="bg-purple-900 flex justify-center items-center rounded gap-2 px-3 py-3 w-[90%] md:w-[80%]
      ...
      grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-2 border-box">
        <div className="bg-purple-800 h-40  flex flex-col items-center justify-center">
          <AlarmClockCheck width={40} height={40} />
          <p className="text-gray-400 mt-3">Format</p>
          <p className="">10min | Rapid</p>
        </div>
        <div className="bg-purple-800 h-40 p-3 flex flex-col items-center justify-center">
