          ...
          <div className="max-w-[100dvw] overflow-x-hidden">
               <div className="bg-[url('/chess-mb.png')] md:bg-[url('/chess-lg.png')] bg-cover">
                    ...
                    <div className="px-4 mt-5 w-full md:w-[80%] lg:w-[60%] xl:w-[50%]">
                         <p className="text-lg text-violet-800 font-semibold">Strategic Elegance</p>
                         <p className="text-base text-violet-700">Step into the gallery of grandmasters. Every move is a stroke
                    ...
                    <div className="flex flex-col w-[97%] mt-5 mx-auto mb-12">
                         <div className="xl:w-[48%] flex flex-col gap-3 mx-auto">
                              <div className="bg-violet-800 p-5 h-65 rounded-lg flex flex-col justify-center">
                                   <div className="flex justify-between items-center">
                                        <div className="bg-violet-600 p-2 rounded"><Star height={38} width={38} /></div>
                                   ...
                                   <button className="mt-3 cursor-pointer bg-violet-600 w-35 px-3 py-2 text-center rounded-lg"
                                    onClick={()=> router.push('/environment/games/chess/createGame')}>Initialize Game</button>
                              </div>
                              <div className="bg-violet-800 p-5 h-65 rounded-lg flex flex-col justify-center">
                                   <div className="flex justify-between items-center">
                                        <div className="bg-violet-600 p-2 rounded"><Shield height={38} width={38} /></div>
                              ...
                              <div className="bg-violet-800 p-5 h-65 rounded-lg flex flex-col justify-center">
                                   <div className="flex justify-between items-center">
                                        <div className="bg-violet-600 p-2 rounded"><Merge height={38} width={38} /></div>
